...
{
	protected $_defaultModel = 'CustomerCategoryModel';
	protected $_pageTitle = 'Customer Category';
	protected $_menuId = 'customer_category';
    ...
    public function index()
	{
		$param = array(
							...
							'title_desc'	=> 'Customer Category',
							'menu_id'		=> $this->_menuId,
							'new'			=> hasPrivilege($this->_menuId,'new')
						);
        return View::make('modules.customer_category.index',$param);
    }
