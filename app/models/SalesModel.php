...
class SalesModel {
	...
	protected $_table = 't_project_sales';
	protected $_detailTable = 't_project_sales_detail';
	protected $_groupDetailTable = 't_project_sales_group_detail';
	protected $_id = 'id_sales';

	public function getLatestSales($idProject)
	{
