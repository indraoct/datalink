		...
		var grid = new Datatable();
				...
				grid.init({
					...
					dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
						"ajax": {
							"url": "{{ URL::to('/') }}/vendor2/get_data", // ajax source
						},
						"order": [
							[1, "asc"]
...
@section('content')
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="portlet">
				@if(hasPrivilege('vendor','new'))
				<div class="portlet-title">
					<div class="btn-group">
						<a href="{{ URL::to('/') }}/vendor2/add"><button class="btn btn green filter-submit tooltips" data-original-title="Create New" id="add"><i class="fa fa-plus"></i></button></a>
					</div>
				</div>
				@endif
			<div class="portlet-body">
					<div class="table-container">
						...
						<tr role="row" class="filter">
							...
							<td>
								<input type="text" class="form-control form-filter input-sm" name="filter[vendor_name]">
							</td>
							<td>
								<input type="text" class="form-control form-filter input-sm" name="filter[address]">
							</td>
							<td>
								<input type="text" class="form-control form-filter input-sm" name="filter[telephone]">
							</td>
							<td>
