                    ...
                    <table class="table table-striped table-bordered table-hover" id="datatable">
                        <thead>
                            ...
                            <tr role="row" class="filter">
                                ...
                                <td>
                                    {{ Form::select("filter[requestor]", $req_l, '', array('class'=>'form-control form-filter input-sm')) }}
                                </td>
                                <td>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
									<div class="radio-list">
										...
										{{ Form::radio('purpose', '1', '', array('id' => 'pp1','checked')) }} Minimum Stock </label>
										<label class="radio-inline">
										{{ Form::radio('purpose', '2','', array('id' => 'pp2')) }} Project  </label>
									</div>
                                </div>
                            </div>
