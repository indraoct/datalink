...
Route::group(array('before' => 'auth'), function() {
    ...
    Route::group(array('prefix' => 'project', 'as' => 'project'), function() {
		...
		Route::post('/item/get_data',array('before'=>'privilege:project,view','uses'=>'ProjectController@getDataItem'));
		...
		Route::get('/quotation/view/{id_project}/{rev}',array('before'=>'privilege:project_quotation,view','uses'=>'ProjectQTController@view'));
    ...
    Route::group(array('prefix' => 'purchase', 'as' => 'purchase'), function() {
        ...
        Route::get('/request/detail/{id}', array('before' => 'privilege:purchase_request,view', 'uses' => 'PurchaseRequestController@getDetail'));
        ...
        Route::post('/request/cek_session', array('before' => 'privilege:purchase_request,new', 'uses' => 'PurchaseRequestController@cekSession'));
        Route::post('/request/konfirmasi', array('before' => 'privilege:purchase_request,new', 'uses' => 'PurchaseRequestController@konfirmasi'));

        /* End Request  */

        /* Modul Order */
        Route::get('/order', array('before' => 'privilege:purchase_order,view', 'uses' => 'PurchaseOrderController@index'));
        Route::get('/order/detail/{id}', array('before' => 'privilege:purchase_order,view', 'uses' => 'PurchaseOrderController@showDetail'));
        ...
        Route::post('/invoice/new', array('before' => 'privilege:purchase_invoice,new', 'uses' => 'PurchaseInvoiceController@add'));
    ...
    Route::group(array('prefix' => 'item', 'as' => 'item'), function() {
        ...
        Route::get('/get_list', array('uses' => 'ItemController@getList'));
    });
    ...
    Route::group(array('prefix' => 'inventory', 'as' => 'inventory'), function() {
        ...
        Route::post('/opname/get_qty_value', array('uses' => 'StockOpnameController@getQtyValue'));
        ...
        /* Modul Good Receipt */
        Route::any('/good_receipt', array('before' => 'privilege:good_receipt,view', 'uses' => 'GoodReceiptController@index'));
        Route::get('/good_receipt/detail/{id_trx}', array('before' => 'privilege:good_receipt,view', 'uses' => 'GoodReceiptController@showDetail'));
        Route::any('/good_receipt/get_data', array('before' => 'privilege:good_receipt,view', 'uses' => 'GoodReceiptController@getData'));
        ...
        Route::get('/good_receipt/new/{id_po}', array('before' => 'privilege:good_receipt,new', 'uses' => 'GoodReceiptNewController@index'));

        Route::any('/good_receipt/new/', array('before' => 'privilege:good_receipt,new', 'uses' => 'GoodReceiptNewController@doProcess'));
        ...
        // new
        Route::get('/delivery_order/new/{id_gr}', array('before' => 'privilege:delivery_order,new', 'uses' => 'DeliveryOrderNewController@index'));
