		...
		var grid = new Datatable();
				...
				grid.init({
					...
					dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
						"ajax": {
							"url": "{{ URL::to('/') }}/project/get_data", // ajax source
						},
						"order": [
							[1, "asc"]
		...
		<div class="col-md-12">
			...
			<div class="portlet">
				...
				<div class="portlet-title">
					<div class="btn-group">
						<a href="{{ URL::to('/') }}/project/add"><button class="btn btn green filter-submit tooltips" data-original-title="Create New" id="add"><i class="fa fa-plus"></i></button></a>
					</div>
				</div>
				@endif
