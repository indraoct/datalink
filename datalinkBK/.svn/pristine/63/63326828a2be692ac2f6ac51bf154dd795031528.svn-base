		...
		var grid = new Datatable();
				...
				grid.init({
					...
					dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
						"ajax": {
							"url": "{{ URL::to('/') }}/warehouse/get_data", // ajax source
						},
						"order": [
							[1, "asc"]
...
@section('content')
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="portlet">
				@if(hasPrivilege('warehouse','new'))
				<div class="portlet-title">
					<div class="btn-group">
						<a href="{{ URL::to('/') }}/warehouse/add"><button class="btn btn green filter-submit tooltips" data-original-title="Create New" id="add"><i class="fa fa-plus"></i></button></a>
					</div>
				</div>
				@endif
						...
						<tr role="row" class="filter">
							...
							<td>
								<input type="text" class="form-control form-filter input-sm" name="filter[address]">
                                                        ...
                                                        <td>
								{{ Form::select('filter[head_person]',$list_head_person,null,array('class'=>'form-control form-filter select2 input-sm')) }}
							</td>
							<td>
								<center>
						...
						<form role="form" id="form" class="form-horizontal" action="#">
							<div class="form-body">
								<div class="form-group">
									...
									<div class="col-md-5">
										{{ Form::textarea('address','',array('id'=>'address','class'=>'form-control','size'=>'10x2')) }}
									</div>
								</div>
									...
									<div class="col-md-5">
										{{ Form::select('head_person',$list_head_person,null,array('id'=>'head_person','class'=>'form-control select2')) }}
									...
									<div class="col-md-5">
										{{ Form::textarea('description','',array('id'=>'description','class'=>'form-control','size'=>'10x2')) }}
									</div>
								</div>
							</div>
						</form>
