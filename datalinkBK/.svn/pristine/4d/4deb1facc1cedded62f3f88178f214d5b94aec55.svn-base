		...
		var grid = new Datatable();
				...
				grid.init({
					...
					dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
						"ajax": {
							"url": "{{ URL::to('/') }}/item_brand/get_data", // ajax source
						},
						"order": [
							[1, "asc"]
...
@section('content')
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="portlet">
				@if(hasPrivilege('item_brand','new'))
			...
			<div class="portlet-body">
					<div class="table-container">
						...
						<tr role="row" class="filter">
							...
							<td>
								<input type="text" class="form-control form-filter input-sm" name="filter[brand_name]">
							</td>
							<td>
						...
						<form role="form" id="form" class="form-horizontal" action="#">
							<div class="form-body">
								<div class="form-group">
									<label class="col-md-3 control-label">Brand Name <font color="red"><strong> * </strong></font></label>
									<div class="col-md-5">
										{{ Form::hidden('act','',array('id'=>'act')) }}
										{{ Form::text('brand_name','',array('id'=>'brand_name','class'=>'form-control')) }}
									</div>
								</div>
							</div>
						</form>
