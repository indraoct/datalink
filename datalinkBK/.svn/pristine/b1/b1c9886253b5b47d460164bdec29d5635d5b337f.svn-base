...
function construct() {
    ...
    {
        $('.item_row').before('<tr class="item-row" id="list-data' + data.id_item + '"><td><a href="" class="btn btn-xs red tooltips do_delete" data-id="' + data.id_item + '" data-original-title="Hapus"><i class="fa fa-trash-o"></i></a></td><td>' + data.nama_item + '</td><td class="currency">' + data.item_stock + ' '+ data.unit +'</td><?php if ($purpose == 1) { ?><td class="currency">' + data.item_min + ' '+ data.unit +'</td><?php } ?><td><input type="text" data-id="' + data.id_item + '" class="list-qty currency" name="qty' + data.id_item + '" value="' + data.item_qty + '"></td></tr>');
                                            ...
                                            if (Session::has('purchase_request')) {
                                                ...
                                                foreach ($pre as $pr1) {
                                                    ...
                                                    <tr class="item-row" id="list-data<?php echo $pr1['id_list']; ?>">
                                                        ...
                                                        <td class="currency"><?php echo $pr1['stock_list'].' '.$pr1['item_unit']; ?></td>
                                                        <?php if ($purpose == 1) { ?>
                                                        <td class="currency"><?php echo $pr1['min_list'].' '.$pr1['item_unit']; ?></td>
                                                        <?php } ?>
