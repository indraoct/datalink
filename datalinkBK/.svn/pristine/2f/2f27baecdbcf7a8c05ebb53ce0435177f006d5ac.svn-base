...
var Layout = function () {
    ...
    var handleSidebarMenu = function () {
		...
		var li = $('li[id="'+ menuId +'"]');
		li.addClass('active');
		var li_parent = li.parent().parent();
		li_parent.addClass('active open');
		li_parent.children('.arrow').addClass('open');
		li_parent.find("a:first").append('<span class="selected"></span>');
		var li_parent2 = li_parent.parent().parent();
		li_parent2.addClass('active open');
		li_parent2.children('.arrow').addClass('open');
		li_parent.find("a:first").append('<span class="selected"></span>');
		var li_parent3 = li_parent2.parent().parent();
		li_parent3.addClass('active open');
		li_parent3.children('.arrow').addClass('open');
		li_parent.find("a:first").append('<span class="selected"></span>');
