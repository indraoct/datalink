...
class VendorCategoryController extends BaseController 
{
	protected $_defaultModel = 'VendorCategoryModel';
	protected $_pageTitle = 'Vendor Category';
	protected $_menuId = 'vendor_category';
    ...
    public function index()
	{
		$param = array(
							...
							'title_desc'	=> 'Vendor Category',
							'menu_id'		=> $this->_menuId,
						);
        return View::make('modules.vendor_category.index',$param);
    }
