...
class ItemBrandController extends BaseController{
    ...
    protected $_defaultModel = 'ItemBrandModel';
    protected $_pageTitle = 'Item Brand';
    protected $_menuId = 'item_brand';
    ...
    public function index()
	{
		$param = array(
							...
							'title_desc'	=> 'Item Brand',
							'menu_id'		=> $this->_menuId,
						);
        return View::make('modules.item_brand.index',$param);
    }
        ...
        public function doAdd()
	{
        ...
        $rules = array('brand_name' => 'required');
    ...
    public function doDelete()
	{
		...
		if($model->hasItem($id))
		{
			$ret = array(
						'status'		=> false,
						'alert_msg'	=> 'The selected brand has item, cannot be deleted.',
						'error_msg'	=> array()
					);
		}
		else
